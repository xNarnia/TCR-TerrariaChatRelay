...
namespace TCRSlack
{
    public class MessageQueue : Dictionary<string, Queue<string>>
    {
        ...
        public MessageQueue(double QueueTime)
        {
        ...
        public void QueueMessage(string channelToSendTo, string message)
            => QueueMessage(new List<string> { channelToSendTo }, message);
        ...
        /// <param name="message">Message to send.</param>
        public void QueueMessage(IEnumerable<string> channelsToSendTo, string message)
        {
        ...
        /// </summary>
        public event Action<Dictionary<string, Queue<string>>> OnReadyToSend;
    }
}